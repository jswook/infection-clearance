...
func _check_p0_art() -> void:
	...
	_assert(P0Art.BOOST_REGION.position.y + P0Art.BOOST_REGION.size.y <= P0Art.BOOST_GOLD_STATS_Y, "이번만 crop stays above gold-stats line")
	_assert(P0Art.goal_card() != null, "goal card atlas")
	_assert(P0Art.fx_kill() != null and P0Art.fx_scrap() != null, "kill/scrap FX atlas")
	_assert(P0Art.player() != null, "player sprite")
	_assert(P0Art.upgrade_blink() is AtlasTexture, "P0 1280 sheet uses atlas crop")
	_assert(P0Art.boost_card() is AtlasTexture, "P0 이번만 1280 sheet uses atlas crop")
	_assert(P0Art.player() is AtlasTexture, "P0 player 1280 sheet uses atlas crop")
	_assert(P0Art.UPGRADE_BLINK.ends_with("ui_upgrade.png"), "upgrade CTA hook is ui_upgrade.png")
	...
	_assert(P0Art.ALL_PATHS.has(P0Art.PLAYER), "swap hook player")
	_assert(P0Art.DIR_UI == "res://art/ui" and P0Art.DIR_ENEMIES == "res://art/enemies" and P0Art.DIR_FX == "res://art/fx" and P0Art.DIR_CHARACTERS == "res://art/characters", "swap dirs")
